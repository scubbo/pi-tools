...
echo "And maybe \`kubectl delete deployments.apps longhorn-admission-webhook longhorn-conversion-webhook longhorn-recovery-backend -n longhorn-system\`, from https://github.com/longhorn/longhorn/issues/6246#issuecomment-1625065311 ?"
exit 1
